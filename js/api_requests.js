...
$(document).ready(function(){
    ...
    $.each(items,function(index,item){
        ...
        data+='<div class="row center " id="guest_lecture_div"><div class="col l3 s12 center"><img src="' +item.Image_url+'" class="minified-img teal-shadow responsive-img circle guest_lecture_image"></div><div class="col l8 s12 offset-l1 left-align "><span class="flow-text lecture_description_text"><strong class="teal-text">'+item.Name+'</strong><br>'+item.Description+'</span></div></div><br>';
    });
