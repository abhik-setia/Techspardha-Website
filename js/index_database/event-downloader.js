...
function populate(event_object)
{
    ...
    var format=".jpg";
    var data='<section><div class="section scrollspy" id="event_'+index+'.jpg"><div class="parallax-container" style="height:  60vh;"><div class="parallax"><img class="responsive-img " src='+event_object.image_path+'></div></div><div class="row black white-text no-bottom-margin" style="height: 100%; min-height: 40vh; padding-left: 16px; margin-bottom: 0px;"><div class="col s8 m8 l8"><h2 class="header">'+event_object.event_name+'</h2></div><div class="row "><div class="col s12 m8 l8"><h4>Description</h4><p class="flow-text">'+event_object.description+'</p></div><div class="col l1 show-on-large-only"></div><div class="col s12 m4 l3 left-align"><h4>Co-ordinators</h4><p class="flow-text">'+event_object.coordinator+'</p></div></div></div><div class="row white-text" style="padding-left: 16px;"><div class="col s12 m12 l8"><h4>Rules</h4><p class="flow-text">'+event_object.rules+'</p></div><div class="col l1 show-on-large-only"></div><div class="col s12 m12 l3"><h4>Schedule</h4><span class="flow-text"><table style="margin-top: 3vh; margin-left: 1vh; padding: 0px;"  ><tbody><tr ><td padding=0>Date</td><td>'+event_object.date+'</td></tr><tr><td>Time</td><td>2:00 pm</td></tr><tr><td>Venue</td><td>'+event_object.venue+'</td></tr></tbody></table></span></div></div><div class="row center"><button class="validate_user btn-large btn-floating pulse" onclick="register('+event_object.registration_details_key+')"><i class="material-icons white-text">navigate_next</i></button></div></div></section>';
